...
func TestAesCBCEnStringHex(t *testing.T) {
	...
	utils.AssertEqual(t, "5f7df0bf103a8c4ae6faad9906ac3b2a", actual)
...
func TestAesCBCEnPKCS7StringHex(t *testing.T) {
	...
	utils.AssertEqual(t, "3c8a535cc4de40f7cf961e54b4e8661f", actual)
...
func TestAesCBCEnStringB58(t *testing.T) {
	...
	utils.AssertEqual(t, "CnvTeK2SG7tByrMkdSKhT7", actual)
...
func TestAesCBCEnPKCS7StringB58(t *testing.T) {
	...
	utils.AssertEqual(t, "8UbX7eoJQNJWbL1GqeM5LJ", actual)
...
func TestAesCBCEnStringB64(t *testing.T) {
	...
	utils.AssertEqual(t, "X33wvxA6jErm-q2ZBqw7Kg==", actual)
...
func TestAesCBCEnPKCS7StringB64(t *testing.T) {
	...
	utils.AssertEqual(t, "PIpTXMTeQPfPlh5UtOhmHw==", actual)
...
func TestAesCBCEncrypt(t *testing.T) {
	...
	utils.AssertEqual(t, "/06zrVSl4UrsshCLDgplgA==", utils.B64Encode(actual))

	actual = AesCBCEncrypt(false, []byte("1"), []byte("abcdefghabcdefgh"))
	utils.AssertEqual(t, "TzlqKoJCo9jWlqZ+gHvhvQ==", utils.B64Encode(actual))

	// 指定向量加密
	actual = AesCBCEncrypt(false, b, []byte("01234567890123456789012345678901"), []byte("abcdefghabcdefgh"))
	utils.AssertEqual(t, "+bmCWToTQ/EvZMbphPZ+cImUgpYrf/q78bflV70zIdpZn4m+l8HNpYkY1A30Y2xh", utils.B64Encode(actual))
}
...
func TestAesCBCEncryptPKCS7(t *testing.T) {
	...
	utils.AssertEqual(t, "+bmCWToTQ/EvZMbphPZ+cImUgpYrf/q78bflV70zIdrGbnwtEDJRdtWYZKF2P0kb", utils.B64Encode(actual))
}
...
func TestAesCBCDecrypt(t *testing.T) {
	...
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(false, nil, nil))
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(false, []byte("1"), nil))
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(false, []byte("1"), []byte("2")))
...
func TestAesCBCDecryptPKCS7(t *testing.T) {
	...
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(true, nil, nil))
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(true, []byte("1"), nil))
	utils.AssertEqual(t, *new([]byte), AesCBCDecrypt(true, []byte("1"), []byte("2")))
