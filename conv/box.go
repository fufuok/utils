...
func toIface(v interface{}) Value {
...
func (v Value) assertIfacePtr() interface{} {
	return *(*interface{})(v.ptr)
}

func (v Value) assertIface() interface{} {
	return *(*interface{})(unsafe.Pointer(&[2]uintptr{
		uintptr(v.ext >> 8),
		uintptr(v.ptr),
	}))
}
...
func (v Value) assertNonPrimAny() interface{} {
	if v.ext&0xFF == ptrIface {
...
func (v Value) primToAny() interface{} {
	switch v.ptr {
	case boolType:
		return v.ext != 0
	case int64Type:
...
// IsFloat returns true if the boxed value is a float-like primitive:
// float32, float64
