...
- 同步 `puzpuzpuz/xsync v2.4.1`, 修复零输入上的 `nextPowOf2`
...
- 增加 `ParseInts`, 解析字符串, 得到去重并排序后的数字列表

## v0.9.12

**2023-03-02**

- 增加 `TrimSlice`, 清除 slice 中各元素的空白, 并删除空白项

## v0.9.11

**2023-02-08**

- 增加闰年判断, 中国时区(GMT+8)初始化函数
- 增加 `conv` 数据类型转换包, 来自: `@tidwall`
- 同步来自 `zyedidia/generic` 的优化, 新增: `Array2D`
