...
func TestGet0DataTime(t *testing.T) {
	...
	AssertEqual(t, "2020-02-18T12:13:14Z", BeginOfSecond(now).Format(time.RFC3339Nano))
	AssertEqual(t, "2020-02-18T12:13:14.999999999Z", EndOfSecond(now).Format(time.RFC3339Nano))
